...
function editableContent(note: WorkspaceNote) {
  if (note.metadataOverride) return safeEditableContent(note.metadataOverride.summary);
  return note.curatedSummary?.trim() ? safeEditableContent(note.curatedSummary) : safeEditableContent(note.plainTextContent);
}
...
function safeEditableContent(value: unknown) {
